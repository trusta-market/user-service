...
public class UserReport extends BaseCreatedEntity {
    ...
    @Builder
    public UserReport(UUID reportId, UUID reporterUserId, UUID reportedUserId, String reason, ReportStatus status, LocalDateTime reviewedAt, UUID reviewedBy, Integer version) {
    ...
    public static UserReport create(UUID reporterUserId, UUID reportedUserId, String reason) {
