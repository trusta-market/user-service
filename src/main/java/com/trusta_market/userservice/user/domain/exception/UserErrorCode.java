...
public enum UserErrorCode implements ErrorCodeSpec {
    ...
    DUPLICATE_NICKNAME(HttpStatus.BAD_REQUEST, "U004", "이미 사용 중인 닉네임입니다."),
    ...
    INVALID_NICKNAME_FORMAT(HttpStatus.BAD_REQUEST, "U010", "올바르지 않은 닉네임 형식입니다."),
    INVALID_REALNAME_FORMAT(HttpStatus.BAD_REQUEST, "U011", "올바르지 않은 실명 형식입니다."),
